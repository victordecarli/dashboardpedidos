...
function AdminDashboardStatsCards({ statistics }) {
  return (
    <Motion.div
      variants={{
        hidden: { opacity: 0 },
        ...
        <div className="bg-white rounded-xl border border-purple-100 shadow-sm p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(statistics.averageOrderValue)}</h3>
            </div>
...
function AdminDashboardRecentOrders({
  isLoadingOrders,
  recentOrders,
  currencyFormat,
  getStatusClass,
...
function AdminDashboardPopularProducts({ isLoadingProduct, products, mostSoldProducts }) {
  return (
    <Motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    <>
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-slate-50 min-h-screen pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          <AdminDashboardStatsCards statistics={statistics} />
